...
até que seja digitado um valor maior do que X para ele). Conte quantos números inteiros devem
ser somados em sequência (considerando o X nesta soma) para que a soma ultrapasse a Z o mínimo possível.
...
para X enquanto os valores 21 e 15 devem ser desconsiderados pois são menores ou iguais a X.
